...
BUILD       	:=  build
LIBBUTANO   	:=  C:/devkitPro/butano/butano
PYTHON      	:=  python
SOURCES     	:=  src 
INCLUDES    	:=  include C:/devkitPro/butano/common/include
DATA        	:=
GRAPHICS    	:=  graphics C:/devkitPro/butano/common/graphics
AUDIO       	:=  audio C:/devkitPro/butano/common/audio
AUDIOBACKEND	:=  maxmod
AUDIOTOOL		:=
DMGAUDIO    	:=  dmg_audio C:/devkitPro/butano/common/dmg_audio
DMGAUDIOBACKEND	:=  default
ROMTITLE    	:=  ROM TITLE
ROMCODE     	:=  SBTP
USERCXXFLAGS	:=  -iquote C:/devkitPro/butano/common/include 
USERASFLAGS 	:=
USERLDFLAGS 	:=
USERLIBDIRS 	:=
USERLIBS    	:=
